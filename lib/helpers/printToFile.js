 ...
 * Author: 3urobeat
 * 
 * Last Modified: 21.01.2022 19:26:41
...
module.exports.printToFile = (str) => {
    ...
    var cleanedStr = str.replace(/\x1B\[([0-9]{1,2}(;[0-9]{1,2})?)?[m|K]/g, "").replace(/\x1B\[\?25[lh]/g, ""); //Regex Credit: https://github.com/Filirom1/stripcolorcodes  + my own \x1B\[\?25[lh] to match hide & show cursor
