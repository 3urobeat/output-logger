 ...
 * Author: 3urobeat
 *
 * Last Modified: 08.06.2023 10:54:54
...
function printCurrentLogToStdout(str = "", remove, cutToWidth, newProgressBar, leaveCursor, ignoreProgressBar) {
    ...
    logCache.forEach((e, i) => {
        ...
        split.forEach((f, j) => {
            ...
            if (((j + 1 == split.length && remove) || cutToWidth) && process.stdout.columns) {
...
module.exports.log = (type, str, remove, cutToWidth) => {
    ...
    switch (type) {
        ...
        case "progressCreate":
            ...
            printCurrentLogToStdout("", false, true, true);
            break;
        ...
        case "progressUpdate":
            ...
            printCurrentLogToStdout("", false, true); // Print without args so that only the progress bar is getting changed and the last message stays the same
            break;
