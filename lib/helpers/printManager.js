 ...
 * Author: 3urobeat
 *
 * Last Modified: 08.06.2023 10:50:36
...
module.exports.log = (type, str, remove) => {
    ...
    switch (type) {
        ...
        case "progressCreate":
            ...
            // Make sure the last content string is also not longer than one terminal line to avoid duplications in stdout
            if (process.stdout.columns) {
                let cutToRegex = new RegExp("(?:(?:\033[[0-9;]*m)*.?){1," + (process.stdout.columns - 1) + "}", "g");
                logCache[0] = logCache[0].match(cutToRegex)[0];
            }
