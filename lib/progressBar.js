 ...
 * Created Date: 2022-04-13 16:29:54
 * Author: 3urobeat
 *
 * Last Modified: 2024-12-22 15:44:32
...
module.exports.createProgressBar = (dontShow) => {
    let newBar = !this.getProgressBar();
...
module.exports.showProgressBar = (firstFrame) => {
    ...
    // Get terminal width and subtract 19 for stuff infront and behind the progress hashtags and 1 for printManager tolerance
    let spaceForProgress = process.stdout.columns - 20;
