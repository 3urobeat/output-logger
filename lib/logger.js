 ...
 * Author: 3urobeat
 * 
 * Last Modified: 30.05.2022 12:10:24
...
module.exports.logger = (args) => {
    ...
    require("./helpers/typeColor.js").typeColor(params, (colorizedParams) => {
        Object.keys(colorizedParams).forEach((e) => {
            ...
            if (!colorizedParams[e] || colorizedParams[e] == "") return; //don't replace fields with empty strings

            //if message type is object then format it using util.inspect()
            if (e == Const.MESSAGE && typeof colorizedParams[e] == "object") tempStr = tempStr.replace(e, util.inspect(colorizedParams[e], false, 2, true)); //https://nodejs.org/en/knowledge/getting-started/how-to-use-util-inspect/
